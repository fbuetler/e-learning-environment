...
The conversion exercises from the decimal number system \textbd{to} either the mayan, decimal coins or binary coins all share the same logic implemented in the \code{To.vue} component.
